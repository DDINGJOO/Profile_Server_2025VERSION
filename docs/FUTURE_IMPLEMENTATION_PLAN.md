...
#### 작업 체크리스트
- [x] build.gradle에 validation 의존성 추가
- [x] 커스텀 어노테이션 생성 (@ValidNickname, @ValidGenres, @ValidInstruments)
- [x] ConstraintValidator 구현체 작성
- [x] ProfileUpdateRequest DTO에 어노테이션 적용
- [x] Controller에서 @Valid 적용
- [ ] GlobalExceptionHandler 개선
- [ ] ErrorResponse DTO에 fieldErrors 필드 추가
- [x] 기존 Validator 클래스 제거 또는 deprecated 처리
- [ ] 검증 관련 단위 테스트 작성
