...
public class UserInfo {
  ...
  public void addInstrument(InstrumentNameTable instrument) {
    ...
    link.setId(new UserInstrumentKey(this.userId, instrument.getInstrumentId()));
  ...
  public void addGenre(GenreNameTable genre) {
    ...
    link.setId(new UserGenreKey(this.userId, genre.getGenreId()));
