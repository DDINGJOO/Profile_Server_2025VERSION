...
public enum ErrorCode {
    ...
    HISTORY_UPDATE_FAILED("PROFILE_002" , "Failed to update history" , HttpStatus.INTERNAL_SERVER_ERROR),
     GENRE_SIZE_INVALID ("PROFILE_003" , "Genre size not valid" , HttpStatus.BAD_REQUEST),
    NOT_ALLOWED_GENRE_ID_AND_NAME("PROFILE_004" , "GenreId and Name are not allowed" , HttpStatus.BAD_REQUEST),
