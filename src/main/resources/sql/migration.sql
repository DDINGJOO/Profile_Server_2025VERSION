...
-- 지역 데이터 삽입
INSERT IGNORE INTO location_names (city_id, city_name)
VALUES ('SEOUL', '서울'),
       ('BUSAN', '부산'),
       ('DAEGU', '대구'),
       ('INCHEON', '인천'),
...
-- 6.3 데이터 개수 확인
SELECT 'user_info' as table_name, COUNT(*) as count
FROM user_info
UNION ALL
SELECT 'location_names', COUNT(*)
FROM location_names
UNION ALL
SELECT 'genre_name', COUNT(*)
FROM genre_name
UNION ALL
SELECT 'instrument_name', COUNT(*)
