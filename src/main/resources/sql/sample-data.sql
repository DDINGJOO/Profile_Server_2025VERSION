...
-- 1. 서울의 록 기타리스트
INSERT INTO user_info (user_id, nickname, profile_image_url, sex, city, introduction, is_public, is_chatable,
                       created_at)
...
INSERT INTO user_genres (user_id, genre_id, version)
VALUES ('user001', 1, 0); -- ROCK
INSERT INTO user_instruments (user_id, instrument_id, version)
VALUES ('user001', 2, 0);
-- GUITAR
...
INSERT INTO user_genres (user_id, genre_id, version)
VALUES ('user007', 18, 0); -- INDIE
INSERT INTO user_instruments (user_id, instrument_id, version)
VALUES ('user007', 2, 0); -- GUITAR
INSERT INTO user_instruments (user_id, instrument_id, version)
VALUES ('user007', 1, 0);
-- VOCAL
...
INSERT INTO user_genres (user_id, genre_id, version)
VALUES ('user010', 13, 0); -- RNB
INSERT INTO user_genres (user_id, genre_id, version)
VALUES ('user010', 14, 0); -- SOUL
INSERT INTO user_instruments (user_id, instrument_id, version)
VALUES ('user010', 3, 0);
-- BASS
