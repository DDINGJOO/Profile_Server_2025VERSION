 ...
 *
 * 테스트 전략:
 * 1. @DataJpaTest로 JPA 슬라이스 테스트
 * 2. 실제 H2 in-memory DB 사용
 * 3. Repository 메서드 단위 테스트
 * 4. 저장, 조회, 존재 여부 확인 등 기본 CRUD 테스트
 */
@DataJpaTest
@ActiveProfiles("test")
...
class UserInfoRepositoryTest {
    ...
    class PagingAndSortingTests {
        ...
        void findAll_WithPaging_Success() {
            ...
            // when
            var page = userInfoRepository.findAll(
        ...
        void findAll_WithSort_Success() {
            ...
            // when
            var sorted = userInfoRepository.findAll(
