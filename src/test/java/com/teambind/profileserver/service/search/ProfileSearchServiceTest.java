...
class ProfileSearchServiceTest {
    ...
    @Mock
    private ProfileSearchRepository repository;
    ...
    class SearchProfiles {
        ...
        void searchProfiles_MultiplePages() {
            ...
            List<UserInfo> firstPageUsers = Arrays.asList(
                    createDefaultUserInfo("user1"),
                    createDefaultUserInfo("user2")
            );
            List<UserInfo> secondPageUsers = Arrays.asList(
                    createDefaultUserInfo("user3"),
                    createDefaultUserInfo("user4")
            );
    ...
    class SearchProfilesByCursor {
        ...
        void searchProfilesByCursor_EmptyResult() {
            ...
            Slice<UserInfo> emptySlice = new SliceImpl<>(Collections.emptyList(), PageRequest.of(0, size), false);
    ...
    class SearchProfilesByIds {
        ...
        void searchProfilesByIds_PartialMatch() {
            ...
            List<UserInfo> foundUsers = Arrays.asList(
                    createDefaultUserInfo("user1"),
                    createDefaultUserInfo("user2")
            );
            ...
            // when
            List<BatchUserSummaryResponse> result = profileSearchService.searchProfilesByIds(requestedIds);
